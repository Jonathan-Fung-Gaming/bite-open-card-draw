...
export const STAGE_REVEAL_REFRESH_INTERVAL_MS = 5_500;
export const STAGE_LIVE_REFRESH_INTERVAL_MS = 500;
export const STAGE_LIVE_REFRESH_JITTER_MS = 0;
export const RESULTS_LIVE_REFRESH_INTERVAL_MS = 1_000;
export const RESULTS_LIVE_REFRESH_JITTER_MS = 0;
